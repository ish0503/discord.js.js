...
module.exports = {
  ...
  async execute(interaction) {
    ...
    var monsters = [
      { name: "죽음", hp: 100000, reward: 2000, XPreward: 10 },
      { name: "최강의 슬라임", hp: 1300, reward: 1900, XPreward: 9 },
      { name: "최강의 새늅봇", hp: 1300, reward: 1800, XPreward: 9 },
      { name: "GPT", hp: 1200, reward: 1700, XPreward: 8 },
      { name: "사이보그", hp: 1000, reward: 1600, XPreward: 7 },
      { name: "봇", hp: 1000, reward: 1500, XPreward: 7 },
      { name: "ks", hp: 1000, reward: 1100, XPreward: 7 },
      { name: "파이어드래곤", hp: 700, reward: 1000, XPreward: 6 },
      { name: "워터드래곤", hp: 600, reward: 900, XPreward: 5 },
      { name: "라이트닝드래곤", hp: 600, reward: 800, XPreward: 5 },
      { name: "드래곤", hp: 500, reward: 700, XPreward: 5 },
      { name: "로즈", hp: 300, reward: 600, XPreward: 4 },
      { name: "애기드래곤", hp: 300, reward: 500, XPreward: 4 },
      { name: "전설의 용사", hp: 200, reward: 400, XPreward: 4 },
      { name: "새늅봇", hp: 100, reward: 300, XPreward: 3 },
      { name: "새뉴비", hp: 100, reward: 200, XPreward: 3 },
      { name: "껌", hp: 50, reward: 150, XPreward: 2 },
      { name: "lk", hp: 25, reward: 100, XPreward: 2 },
      { name: "슬라임", hp: 10, reward: 50, XPreward: 2 },
      { name: "풀", hp: 5, reward: 30, XPreward: 1 },
